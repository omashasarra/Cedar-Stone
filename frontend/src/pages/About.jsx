      ...
      {isTouchDevice ? (
        ...
        >
          ...
          >
            ...
            <div className="w-full flex-1 flex items-start justify-center pt-1 overflow-hidden">
              <div className="font-['Century_Gothic',sans-serif] text-[9px] sm:text-[11px] text-stone-700 leading-relaxed font-normal text-justify hyphens-auto [text-justify:inter-character] max-w-[95%] whitespace-pre-wrap">
                {typedText}
        ...
        <div className="relative w-full h-full bg-[#faf9f6] border border-stone-200/80 p-4 sm:p-8 flex flex-col items-center justify-center text-center overflow-hidden transition-all duration-700 [cubic-bezier(0.16,1,0.3,1)] hover:border-[#8c7a6b]/50 hover:shadow-2xl hover:shadow-stone-900/5">
          ...
          <div className="absolute inset-0 bg-[#faf9f6]/95 backdrop-blur-sm p-3 sm:p-6 flex flex-col items-center justify-center text-center opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out">
            ...
            <p className="font-['Century_Gothic',sans-serif] text-justify hyphens-auto [text-justify:inter-character] text-[10px] sm:text-[13px] text-stone-700 leading-relaxed font-normal max-w-[90%] translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-150">
    ...
    <div>
      ...
      <section className="relative h-[480px] sm:h-[560px] md:h-[620px] overflow-hidden">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-5 sm:px-8 flex items-end pb-12 sm:pb-16">
          <div className="max-w-xl ltr:max-w-2xl md:ltr:max-w-3xl">
            ...
            <p className="font-['Century_Gothic',_Futura,_sans-serif] text-justify hyphens-auto [text-justify:inter-character] text-stone-100/90 mt-4 sm:mt-5 text-xs sm:text-sm md:text-base leading-relaxed">
        ...
        <section className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          >
            ...
            <div>
              ...
              <p className="text-white/90 text-[11px] sm:text-xs leading-relaxed font-['Century_Gothic',sans-serif] font-light text-justify hyphens-auto [text-justify:inter-character]">
                {t("about.impactBody")}
              </p>
            </div>
          </Swatch>
          ...
          <div className="lg:col-span-8 bg-white h-auto sm:h-[300px] rounded-2xl flex flex-col sm:flex-row items-stretch justify-between shadow-2xl overflow-hidden">
            ...
            <div className="w-full sm:w-5/12 flex flex-col justify-center p-5 sm:p-6 text-left rtl:text-right shrink-0">
              ...
              <p className="text-[11px] sm:text-xs text-stone-700 leading-normal sm:leading-relaxed font-['Century_Gothic',sans-serif] font-light text-justify hyphens-auto [text-justify:inter-character]">
                {t("about.legacyBody")}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
          <div className="flex flex-col gap-6 w-full">
            ...
            <div className="bg-[#f4f4f4] p-6 sm:p-12 drop-shadow-[0_12px_20px_rgba(0,0,0,0.15)] shadow-stone-400/20 min-h-[170px] flex flex-col justify-center text-left rtl:text-right">
              ...
              <p className="font-['Century_Gothic',sans-serif] text-justify hyphens-auto [text-justify:inter-character] text-xs sm:text-[14px] text-stone-800 leading-relaxed font-normal">
                {t("about.missionBody")}
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {valuesData.map(({ key, icon }) => (
              ...
              >
                ...
                <p className="font-['Century_Gothic',sans-serif] text-justify hyphens-auto [text-justify:inter-character] text-[10px] sm:text-[13px] text-stone-600 leading-relaxed font-normal">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="font-['Century_Gothic',sans-serif] text-justify hyphens-auto [text-justify:inter-character] text-xs sm:text-sm text-stone-500 leading-relaxed max-w-md mb-4 lg:mb-0">
                    {step.body}
                  </p>
                </div>
      ...
      <section className="bg-[#E2E0DB] py-12 sm:py-16 px-4 sm:px-12 lg:px-20">
        ...
        text-xl sm:text-3xl text-stone-900 uppercase tracking-widest mb-4 text-center md:text-left rtl:md:text-right`}
          ...
          <p
            className={`text-xs sm:text-sm text-stone-700 max-w-3xl mb-8 sm:mb-12 font-['Century_Gothic',sans-serif] text-justify hyphens-auto [text-justify:inter-character] text-center md:text-left rtl:md:text-right ${
              isRTL ? "md:ml-auto" : ""
            }`}
          >
